...
import com.api.twitter.constants.Auth1;
...
public class RestUtilities {
	...
	public static RequestSpecification getRequestSpecification() {
		AuthenticationScheme authScheme = RestAssured.oauth(Auth1.CONSUMER_KEY, Auth1.CONSUMER_SECRET, Auth1.ACCESS_TOKEN, Auth1.ACCESS_SECRET);
